  ...
  const testimonials = [
    {
      name: "Alex Johnson",
      location: "California",
      quote: "Motorove has completely changed how I connect with other riders. I've found incredible routes and made lifelong friends through the app.",
      avatar: "/assets/images/testimonials/rider1.jpg",
      bike: "Ducati Panigale V4",
    },
    {
      name: "Sarah Chen",
      location: "New York",
      quote: "The events feature is fantastic! I've attended group rides I never would have found otherwise. The weather alerts have saved me from getting caught in the rain multiple times.",
      avatar: "/assets/images/testimonials/rider2.jpg",
      bike: "Triumph Street Triple",
    },
    {
      name: "Michael Rodriguez",
      location: "Texas",
      quote: "As a new rider, the community has been incredibly welcoming. I've learned so much from more experienced riders and found repair shops I can trust.",
      avatar: "/assets/images/testimonials/rider3.jpg",
      bike: "Honda CB650R",
    }
  ];
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-grey">{testimonial.location}</p>
                </div>
              </div>
