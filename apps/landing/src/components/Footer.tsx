  ...
  return (
    ...
    >
      ...
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {icon === "twitter" && (
          <path d="M23.64 4.54c-.77.36-1.6.6-2.46.7.88-.53 1.56-1.37 1.88-2.38-.83.5-1.75.85-2.72 1.05C19.54 3.03 18.4 2.5 17 2.5c-2.7 0-4.87 2.2-4.87 4.9 0 .4.04.77.13 1.13-4.04-.2-7.62-2.13-10.02-5.06-.42.72-.66 1.56-.66 2.46 0 1.7.87 3.2 2.18 4.08-.8-.03-1.55-.24-2.2-.6v.06c0 2.38 1.7 4.36 3.95 4.8-.4.1-.82.16-1.26.16-.3 0-.6-.03-.9-.08.63 1.95 2.45 3.37 4.6 3.4-1.7 1.33-3.82 2.12-6.14 2.12-.4 0-.8-.02-1.18-.06 2.18 1.4 4.76 2.22 7.55 2.22 9.06 0 14-7.5 14-14v-.6c.96-.7 1.8-1.56 2.45-2.54z" />
        )}
        {icon === "instagram" && (
