...
interface PrivacyMobilePageProps {
  params: {
    locale: string;
  };
}

export default function PrivacyMobilePage({ params }: PrivacyMobilePageProps) {
  const { locale } = params;
...
function PrivacyMobileContent() {
  ...
  return (
    <main className="bg-neutral-white text-neutral-black min-h-screen">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <section className="mb-10">
              ...
              <h3 className="text-xl font-bold mt-6 mb-3">
                {t("legal.privacy.sections.dataCollection.personalData.title")}
              </h3>
            ...
            <section className="mb-10">
              ...
              <p className="mt-4">
                {t("legal.privacy.sections.yourRights.contact")}
              </p>
            </section>
