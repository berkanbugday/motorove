...
export const UPDATE_GROUP_MEMBERSHIP_APPROVAL_STATUS = gql`
  mutation UpdateGroupMembershipApprovalStatus(
    $input: UpdateGroupMembershipApprovalStatusInput!
  ) {
    updateGroupMembershipApprovalStatus(input: $input) {
      status
    }
  }
`;
