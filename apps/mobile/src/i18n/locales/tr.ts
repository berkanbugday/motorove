export default {
  ...
  components: {
    ...
    emergencyBottomSheet: {
      ...
      emergency_title: 'Acil Durum Başlığı',
      title_placeholder: 'Acil durumun kısa açıklaması...',
      additional_details: 'Ek Detaylar (Opsiyonel)',
      description_placeholder: 'Durum hakkında daha fazla detay verin...',
      location_info: 'Mevcut konumunuz yakındaki sürücülerle paylaşılacak',
      send_emergency: 'Acil Durum Uyarısı Gönder',
      cancel_title: 'Acil Durumu İptal Et',
      cancel_message:
        'Acil durum uyarısını göndermekten vazgeçmek istediğinizden emin misiniz?',
      select_type_error: 'Lütfen bir acil durum türü seçin',
      title_required_error: 'Acil durum başlığı gereklidir',
      location_error: 'Konumunuz alınamadı. Lütfen tekrar deneyin.',
      emergency_sent: 'Acil Durum Uyarısı Gönderildi!',
      help_on_way: 'Yakındaki sürücüler bilgilendirildi ve yardım yolda.',
    },
