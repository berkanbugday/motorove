export default {
  ...
  screens: {
    ...
    group: {
      ...
      join_success: 'Grup başarıyla katıldınız!',
      people: 'Kişi',
      select_role: 'Rol Seç',
      remove_member_confirmation:
        '{name} üyesini gruptan kaldırmak istediğinize emin misiniz?',
      remove_member_generic: 'Bu üyeyi kaldırmak istediğinize emin misiniz?',
