export default {
  ...
  screens: {
    ...
    map: {
      ...
      no_address_provided: 'Adres sağlanmadı',
      // Business card translations
      business: 'İşletme',
      repair_shop: 'Tamir Servisi',
      dealer: 'Bayi',
      washing_station: 'Yıkama İstasyonu',
      not_available: 'Mevcut değil',
      address_not_available: 'Adres mevcut değil',
      distance_unknown: 'Mesafe bilinmiyor',
      based_on_your_location: 'Konumunuza göre',
      km_away: 'km uzakta',
      new_business: 'Yeni işletme',
      no_phone_number: 'Telefon numarası yok',
      tap_to_call: 'Aramak için dokunun',
      hours_not_provided: 'Çalışma saatleri belirtilmemiş',
      open_24h: '24 saat açık',
      open_now: 'Şu anda açık',
      closed_now: 'Şu anda kapalı',
      closed_today: 'Bugün kapalı',
      get_directions: 'Yol Tarifi Al',
      call_now: 'Şimdi Ara',
      save_to_favorites: 'Favorilere Ekle',
      remove_from_favorites: 'Favorilerden Çıkar',
      nearby_places: 'Yakındaki Yerler',
      nearby_place: 'Yakındaki Yer',
      new: 'Yeni',
    },
