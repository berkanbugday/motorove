export default {
  ...
  errors: {
    ...
    auth: {
      ...
      bad_code_verifier: 'Code verifier does not match. Please try again.',
      bad_json: 'Invalid data format.',
      bad_jwt: 'Invalid authentication token.',
      bad_oauth_callback: 'OAuth callback failed.',
      ...
      email_conflict_identity_not_deletable: 'This identity cannot be removed.',
      ...
      hook_payload_invalid_content_type: 'Invalid content type.',
      hook_payload_over_size_limit: 'Data size limit exceeded.',
      hook_timeout: 'Request timed out.',
      hook_timeout_after_retry: 'Timeout after retry.',
      ...
      mfa_challenge_expired: 'Two-factor authentication expired.',
      mfa_factor_name_conflict: 'Two-factor authentication name conflict.',
      mfa_factor_not_found: 'Two-factor authentication not found.',
      mfa_ip_address_mismatch: 'IP address mismatch.',
      mfa_phone_enroll_not_enabled:
        'Phone two-factor authentication is disabled.',
      mfa_phone_verify_not_enabled: 'Phone verification is disabled.',
      mfa_totp_enroll_not_enabled:
        'TOTP two-factor authentication is disabled.',
      mfa_totp_verify_not_enabled: 'TOTP verification is disabled.',
      mfa_verification_failed: 'Two-factor authentication failed.',
      mfa_verification_rejected: 'Two-factor authentication rejected.',
      mfa_verified_factor_exists: 'Verified phone already exists.',
      mfa_web_authn_enroll_not_enabled:
        'WebAuthn two-factor authentication is disabled.',
      ...
      over_email_send_rate_limit: 'Too many emails sent. Please wait.',
      over_request_rate_limit: 'Too many requests sent. Please wait.',
      over_sms_send_rate_limit: 'Too many SMS sent. Please wait.',
      phone_exists: 'Phone number already in use.',
      phone_not_confirmed: 'Phone number not verified.',
      phone_provider_disabled: 'Phone sign-ups are disabled.',
      provider_disabled: 'Provider is disabled.',
      provider_email_needs_verification: 'Email verification required.',
      reauthentication_needed: 'Reauthentication required to change password.',
      reauthentication_not_valid: 'Reauthentication failed.',
      refresh_token_already_used: 'Session expired. Please sign in again.',
      refresh_token_not_found: 'Session not found.',
      request_timeout: 'Request timed out. Please try again.',
      same_password: 'New password must be different from current password.',
      saml_assertion_no_email: 'Email not found in SAML authentication.',
      saml_assertion_no_user_id: 'User ID not found in SAML authentication.',
      saml_entity_id_mismatch: 'SAML identity provider mismatch.',
      ...
      saml_relay_state_expired: 'SAML session expired.',
      saml_relay_state_not_found: 'SAML session not found.',
      session_not_found: 'Session not found.',
      signup_disabled: 'New registrations are disabled.',
      single_identity_not_deletable: 'Last identity cannot be deleted.',
      ...
      too_many_enrolled_mfa_factors:
        'Too many two-factor authentication methods.',
      ...
      user_sso_managed: 'SSO-managed user fields cannot be changed.',
