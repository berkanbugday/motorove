export default {
  ...
  components: {
    ...
    emergencyBottomSheet: {
      ...
      title_placeholder: 'Brief description of the emergency...',
      additional_details: 'Additional Details (Optional)',
      description_placeholder: 'Provide more details about the situation...',
      location_info: 'Your current location will be shared with nearby riders',
      send_emergency: 'Send Emergency Alert',
      cancel_title: 'Cancel Emergency',
      cancel_message:
        'Are you sure you want to cancel sending the emergency alert?',
      select_type_error: 'Please select an emergency type',
      title_required_error: 'Emergency title is required',
      location_error: 'Unable to get your location. Please try again.',
      emergency_sent: 'Emergency Alert Sent!',
      help_on_way: 'Nearby riders have been notified and help is on the way.',
    },
